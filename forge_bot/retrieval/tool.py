...
# Paths excluded from file discovery.
_FIND_EXCLUDES = (
...
class RetrievalTool(BaseTool):
    ...
    async def execute(self, **kwargs: object) -> ToolResult:
        ...
        check = await self._cm.exec(
            "test -d /workspace/.git && echo ok", timeout=5,
        )
        ...
        try:
            ...
            if len(sources) > 5 and total_tokens > budget.available:
                ...
                answer = await self._retriever.scan_and_answer(
                    query, combined, source=path or "repository",
                )
        ...
        if len(all_files) > _SMALL_REPO_THRESHOLD:
            ...
            if keywords:
                ...
                grep_result = await self._cm.exec(
                    ...
                    f"{shlex.quote(root)} {_FIND_EXCLUDES} "
                ...
                if narrowed:
                    ...
                    # Grep found nothing — fall back to first N files.
    ...
    def _extract_keywords(query: str) -> list[str]:
        ...
        stop = {
            ...
            "below", "between", "how", "what", "where", "when", "which",
            "who", "whom", "why", "this", "that", "these", "those",
            "i", "me", "my", "we", "our", "you", "your", "he", "him",
            "his", "she", "her", "it", "its", "they", "them", "their",
            "if", "then", "else", "while", "until", "up", "down",
            "out", "off", "over", "under", "again", "further",
            "there", "here", "find", "show", "tell", "explain",
            "describe", "get", "use", "using", "used",
        }
